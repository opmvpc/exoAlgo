...
class LongestCommonSubsequenceDynamicTest {
    ...
    int testCommonSubseq(String first, String second) {
        return new LongestCommonSubsequenceDynamic<>(first.split(""), second.split("")).longestSize();
    }

    @Test
    void testCasDeBase() {
        int expected = 0;
        int actual = new LongestCommonSubsequenceDynamic<>(new String[]{}, new String[]{}).longestSize();
